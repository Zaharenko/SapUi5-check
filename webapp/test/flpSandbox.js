		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customizing Instractions",
									"targetURL": "#sapui5worklistcustint-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5worklistcustint-display": {
								"semanticObject": "sapui5worklistcustint",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5.worklist.custint",
									"url": sap.ui.require.toUrl("sapui5/worklist/custint")
								}
							}
						}
					}
